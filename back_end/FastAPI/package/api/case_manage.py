        ...
        try:
            ...
            if case_category == "银行案件":
                bank_details = {
                    ...
                    "freeze_start_date": parse_date(row_data.get("冻结开始日期")),
                    "freeze_end_date": parse_date(row_data.get("冻结截止日期")),
                    "seizure_start_date": parse_date(row_data.get("查封开始日期")),
                    "seizure_end_date": parse_date(row_data.get("查封截止日期")),
            ...
            new_case = CaseCreate(
                ...
                claim_amount=str(row_data.get("诉讼标的额", "")).strip() or None,
    ...
    for row_idx, row_values in enumerate(ws.iter_rows(min_row=2, values_only=True), start=2):
        ...
        try:
            ...
            case_update_dict = {
                ...
                "claim_amount": row_data.get("诉讼标的额"),
                "case_income": parse_decimal(row_data.get("案件收入")),
                "payment_due_date": parse_date(row_data.get("付款到期日")),
