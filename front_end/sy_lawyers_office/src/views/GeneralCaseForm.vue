            ...
            <el-row :gutter="10">
              <el-col :span="8">
                <el-form-item
                  ...
                  label-width="90px"
                >
                  <el-input v-model="item.name" placeholder="请输入姓名" :disabled="isRestricted" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item
              ...
              <el-col :span="8">
                <el-form-item
                  ...
                  :rules="[
                    { required: true, message: '请输入身份证/统一社会信用代码', trigger: 'blur' },
          ...
          <div class="party-card-body">
            <el-row :gutter="10">
              <el-col :span="5">
                ...
                >
                  <el-select v-model="item.party_type" :disabled="isRestricted">
